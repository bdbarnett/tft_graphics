...
def center(text, fg=Graphics.WHITE, bg=Graphics.BLACK):
    """
...
def main():
    ...
    The big show!
    """
    for color in [Graphics.RED, Graphics.GREEN, Graphics.BLUE]:
        tft.fill(color)
        tft.rect(0, 0, tft.width, tft.height, Graphics.WHITE)
        center("Hello!", Graphics.WHITE, color)
        time.sleep(1)
