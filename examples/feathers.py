...
def color_wheel(position):
    ...
    if position < 85:
        return Graphics.color565(255 - position * 3, 0, position * 3)

    if position < 170:
        position -= 85
        return Graphics.color565(0, position * 3, 255 - position * 3)

    position -= 170
    return Graphics.color565(position * 3, 255 - position * 3, 0)
...
def main():
    ...
    tft.fill(Graphics.BLACK)  # clear screen
