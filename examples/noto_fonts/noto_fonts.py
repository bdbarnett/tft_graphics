...
def main():
    ...
    def center(font, string, row, color=Graphics.WHITE):
        """
        ...
        Args:
            ...
            color: The color of the string (default: Graphics.WHITE).
